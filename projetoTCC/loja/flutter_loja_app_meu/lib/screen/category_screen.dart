...
import 'package:flutter_loja_app_meu/tiles/product_tile.dart';
  ...
  Widget build(BuildContext context) {
    return DefaultTabController(
      ...
      child: Scaffold(
        ...
        //doc é uma fotografia apenas de um docSnapshot de aapenas um documento
          //querySnapshot é a fotografia de uma coleção
